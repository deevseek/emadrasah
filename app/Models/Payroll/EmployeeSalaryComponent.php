...
{
    protected $table = 'employee_salary_profile_components';
    protected $guarded = [];
    public function payrollComponent(){return $this->belongsTo(PayrollComponent::class);} public function profile(){return $this->belongsTo(EmployeeSalaryProfile::class,'employee_salary_profile_id');}
