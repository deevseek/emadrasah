...
{
    protected $guarded = [];
    public function run(){return $this->belongsTo(PayrollRun::class,'payroll_run_id');} public function components(){return $this->hasMany(PayrollItemComponent::class);} public function payments(){return $this->hasMany(PayrollPayment::class);} public function adjustments(){return $this->hasMany(PayrollAdjustment::class);}
