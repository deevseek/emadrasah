...
{
    protected $fillable = ['type','original_filename','academic_year_id','semester_id','status','total_rows','valid_rows','imported_rows','updated_rows','skipped_rows','error_rows','imported_by','started_at','finished_at','metadata'];
