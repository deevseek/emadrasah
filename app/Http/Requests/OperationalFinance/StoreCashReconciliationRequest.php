...
class StoreCashReconciliationRequest extends FormRequest
{
    ...
    public function rules(): array { return ['cash_account_id' => ['required', 'exists:cash_accounts,id'], 'reconciliation_date' => ['required', 'date'], 'actual_balance' => ['required', 'numeric', 'min:0'], 'notes' => ['required', 'string', 'max:1000']]; }
