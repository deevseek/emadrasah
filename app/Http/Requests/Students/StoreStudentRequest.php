...
class StoreStudentRequest extends FormRequest
{
 ...
 public function messages():array{return ['required'=>':attribute wajib diisi.','unique'=>':attribute sudah digunakan.','before_or_equal'=>'Tanggal lahir tidak boleh di masa depan.','in'=>':attribute tidak valid.','image'=>'Foto siswa harus berupa gambar.','mimes'=>'Foto siswa harus berformat JPG, JPEG, PNG, atau WEBP.','max'=>':attribute terlalu panjang.','photo.max'=>'Ukuran foto siswa maksimal 5 MB.'];}
