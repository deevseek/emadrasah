...
class StudentAttendanceFilterRequest extends FormRequest
{
    ...
    public function rules(): array { return ['from'=>['nullable','date'],'to'=>['nullable','date'],'date'=>['nullable','date'],'classroom_id'=>['nullable','integer'],'student_id'=>['nullable','integer'],'status'=>['nullable','string'],'q'=>['nullable','string','max:100']]; }
}
