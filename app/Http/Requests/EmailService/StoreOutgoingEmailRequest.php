...
class StoreOutgoingEmailRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'to_addresses.array' => 'Format alamat email tujuan tidak valid.',
            'to_addresses.min' => 'Alamat email tujuan wajib diisi.',
            'to_addresses.max' => 'Alamat email tujuan maksimal 50 alamat.',
            'to_addresses.*.required' => 'Alamat email tujuan tidak boleh kosong.',
            'to_addresses.*.email' => 'Salah satu alamat email tujuan tidak valid.',
            'to_addresses.*.max' => 'Panjang alamat email tujuan maksimal 254 karakter.',
            'cc_addresses.array' => 'Format alamat CC tidak valid.',
            'cc_addresses.max' => 'Alamat CC maksimal 50 alamat.',
            'cc_addresses.*.required' => 'Alamat CC tidak boleh kosong.',
            'cc_addresses.*.email' => 'Salah satu alamat CC tidak valid.',
            'cc_addresses.*.max' => 'Panjang alamat CC maksimal 254 karakter.',
            'bcc_addresses.array' => 'Format alamat BCC tidak valid.',
            'bcc_addresses.max' => 'Alamat BCC maksimal 50 alamat.',
            'bcc_addresses.*.required' => 'Alamat BCC tidak boleh kosong.',
            'bcc_addresses.*.email' => 'Salah satu alamat BCC tidak valid.',
            'bcc_addresses.*.max' => 'Panjang alamat BCC maksimal 254 karakter.',
            ...
            'body.string' => 'Isi email harus berupa teks.',
            'body.max' => 'Isi email maksimal 100.000 karakter.',
            'attachments.array' => 'Format lampiran tidak valid.',
            'attachments.max' => 'Lampiran maksimal 5 file.',
            'attachments.*.file' => 'Lampiran yang dipilih harus berupa file.',
            ...
            'action.required' => 'Tindakan pengiriman email wajib dipilih.',
            'action.in' => 'Tindakan pengiriman email tidak valid.',
        ];
    }
}
