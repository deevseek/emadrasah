...
class UpdateHrdSettingRequest extends FormRequest
{
    ...
    public function rules():array{return [
        ...
        'hrd_early_checkin_minutes'=>['required','integer','between:0,720'],'hrd_max_late_checkin_minutes'=>['required','integer','between:1,720'],'hrd_face_recognition_enabled'=>['required','boolean'],'hrd_payroll_by_attendance_enabled'=>['required','boolean'],'hrd_payroll_auto_late_deduction_enabled'=>['required','boolean'],'hrd_payroll_auto_cash_advance_deduction_enabled'=>['required','boolean'],
    ];}
}
