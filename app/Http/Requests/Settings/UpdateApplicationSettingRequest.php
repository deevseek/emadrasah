...
class UpdateApplicationSettingRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        foreach (['hrd_face_recognition_enabled','hrd_attendance_location_enabled','hrd_attendance_face_enabled','hrd_attendance_device_binding_enabled','hrd_attendance_anti_replay_enabled','hrd_attendance_new_device_requires_approval','hrd_payroll_by_attendance_enabled','hrd_payroll_auto_late_deduction_enabled','hrd_payroll_auto_cash_advance_deduction_enabled'] as $key) $data[$key] = $this->boolean($key);
