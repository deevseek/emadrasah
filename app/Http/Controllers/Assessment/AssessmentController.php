...
class AssessmentController extends Controller
{
    ...
    public function publish(AssessmentComponent $assessmentComponent): RedirectResponse { $assessmentComponent->update(['status'=>'published','published_at'=>now()]); activity('assessment')->performedOn($assessmentComponent)->log('Komponen dipublish'); return back()->with('status','Nilai dipublish.'); }
