...
class ScheduleImportController extends Controller
{
 ...
 public function expiredPreview():RedirectResponse{return redirect()->route('schedules.import')->with('status','Sesi preview telah berakhir. Silakan unggah kembali berkas untuk membuat preview baru.');}
