...
class TeachingAssignmentImportController extends Controller
{
    ...
    public function expiredPreview():RedirectResponse{return redirect()->route('teaching-assignments.import')->withErrors(['preview'=>'Sesi preview telah berakhir. Silakan unggah kembali berkas.']);}
