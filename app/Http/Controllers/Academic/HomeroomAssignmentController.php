...
class HomeroomAssignmentController extends Controller
{
    ...
    { $employees=Employee::where('is_active',true)->whereIn('employment_type',[EmploymentType::ClassTeacher,EmploymentType::Principal])->orderByRaw("employment_type = 'guru_kelas' desc")->orderBy('name')->get(); return view('academic.classrooms.homeroom',['classroom'=>$classroom->load('activeHomeroomAssignment.employee'),'employees'=>$employees]); }
