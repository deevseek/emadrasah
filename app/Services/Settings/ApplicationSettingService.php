...
class ApplicationSettingService
{
    ...
    public const DEFAULTS = [
        ...
        'hrd_attendance_location_enabled' => true, 'hrd_attendance_face_enabled' => false,
        'hrd_attendance_device_binding_enabled' => true, 'hrd_attendance_anti_replay_enabled' => true,
        ...
        'hrd_face_confidence_threshold' => '0.50', 'hrd_attendance_max_devices' => 2,
        ...
        'hrd_early_checkin_minutes' => 60, 'hrd_max_late_checkin_minutes' => 240, 'hrd_min_checkout_hours' => 0, 'hrd_face_recognition_enabled' => false,
    ...
    private function typeFor(string $key): string { return match ($key) { 'maintenance_mode', 'attendance_rfid_enabled', 'rfid_writer_enabled', 'hrd_face_recognition_enabled', 'hrd_attendance_location_enabled','hrd_attendance_face_enabled','hrd_attendance_device_binding_enabled','hrd_attendance_anti_replay_enabled','hrd_attendance_new_device_requires_approval','hrd_payroll_by_attendance_enabled', 'hrd_payroll_auto_late_deduction_enabled', 'hrd_payroll_auto_cash_advance_deduction_enabled' => 'boolean', 'pagination_size', 'hrd_attendance_radius_meter','hrd_attendance_max_accuracy_meter','hrd_attendance_location_max_age_seconds','hrd_attendance_challenge_ttl_seconds','hrd_face_verification_ttl_seconds','hrd_attendance_max_devices', 'hrd_shift_count', 'hrd_early_checkin_minutes', 'hrd_max_late_checkin_minutes', 'hrd_min_checkout_hours' => 'integer', 'primary_logo', 'login_logo', 'print_logo', 'favicon' => 'file', default => 'string' }; }
