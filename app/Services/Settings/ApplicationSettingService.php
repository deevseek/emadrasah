...
class ApplicationSettingService
{
    ...
    private function typeFor(string $key): string { return match ($key) { 'maintenance_mode' => 'boolean', 'pagination_size' => 'integer', 'primary_logo', 'login_logo', 'print_logo', 'favicon' => 'file', default => 'string' }; }
    private function groupFor(string $key): string { return match ($key) { 'primary_logo', 'login_logo', 'print_logo', 'favicon' => 'branding', 'primary_color', 'default_theme', 'sidebar_mode' => 'appearance', 'default_language', 'timezone', 'date_format', 'time_format', 'first_day_of_week' => 'localization', 'maintenance_mode', 'maintenance_message', 'pagination_size' => 'system', default => 'general' }; }
}
