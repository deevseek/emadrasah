...
final class MimnuSubjectSeeder extends Seeder
{
    ...
    private function subjects(): array
    {
        ...
        return [
            ...
            ['code' => 'BAR', 'name' => 'Bahasa Arab', 'short_name' => 'B. Arab', 'category' => SubjectCategory::Religion, 'default_weekly_hours' => 2, 'levels' => $all],
            ...
            ['code' => 'MTK', 'name' => 'Matematika', 'short_name' => 'Matematika', 'category' => SubjectCategory::General, 'default_weekly_hours' => 5, 'levels' => $all],
            ...
            ['code' => 'TAQ', 'name' => "Takhassus Al-Qur'an", 'short_name' => 'Takhassus', 'category' => SubjectCategory::Btaq, 'default_weekly_hours' => 12, 'levels' => [1]],
