...
class AccessControlSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roles = [
            ...
            'kepala-madrasah' => ['Kepala Madrasah', 'Memantau data utama madrasah, periode akademik, personalia, pengguna, dan hak akses.', ['academic-attendance.view', 'academic-grades.view', 'academic-reports.view', 'academic-reports.export', 'dashboard.view', 'school-profile.view', 'academic-periods.view', 'personnel.view', 'personnel.view-sensitive', 'personnel.export', 'students.view', 'students.view-sensitive', 'students.export', 'classrooms.view', 'users.view', 'roles.view']],
            'operator' => ['Operator', 'Mengelola data operasional, akun, periode akademik, dan personalia madrasah.', ['academic-attendance.view', 'academic-attendance.manage', 'academic-grades.view', 'academic-grades.manage', 'academic-reports.view', 'academic-reports.export', 'dashboard.view', 'school-profile.view', 'school-profile.update', 'school-profile.update-logo', 'school-profile.update-leader', 'academic-periods.view', 'academic-periods.create', 'academic-periods.update', 'academic-periods.activate', 'personnel.view', 'personnel.create', 'personnel.update', 'personnel.activate', 'personnel.manage-account', 'personnel.view-sensitive', 'personnel.import', 'personnel.export', 'students.view', 'students.create', 'students.update', 'students.change-status', 'students.view-sensitive', 'students.import', 'students.export', 'classrooms.view', 'classrooms.create', 'classrooms.update', 'classrooms.activate', 'classrooms.assign-homeroom', 'classrooms.manage-students', 'classrooms.map-legacy', 'classrooms.copy-structure', 'classrooms.promote', 'users.view', 'users.create', 'users.update', 'users.activate', 'users.reset-password', 'users.assign-role', 'roles.view']],
            'guru' => ['Guru', 'Mengakses layanan dasar yang disediakan untuk guru.', ['academic-attendance.view', 'academic-attendance.manage', 'academic-grades.view', 'academic-grades.manage', 'academic-reports.view', 'dashboard.view', 'school-profile.view', 'academic-periods.view', 'classrooms.view-own']],
        ];
