...
class AccessControlSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roles = [
            ...
            'operator' => ['Operator', 'Mengelola data operasional, akun, periode akademik, dan personalia madrasah.', ['rfid-cards.manage', 'academic-subjects.view', 'academic-subjects.manage', 'teaching-journals.view', 'teaching-journals.manage', 'teaching-journals.view-all', 'classroom-journals.view', 'classroom-journals.manage', 'classroom-journals.view-all', 'academic-attendance.view', 'academic-attendance.manage', 'academic-grades.view', 'academic-grades.manage', 'academic-reports.view', 'academic-reports.export', 'dashboard.view', 'school-profile.view', 'school-profile.update', 'school-profile.update-logo', 'school-profile.update-leader', 'academic-periods.view', 'academic-periods.create', 'academic-periods.update', 'academic-periods.activate', 'personnel.view', 'personnel.create', 'personnel.update', 'personnel.activate', 'personnel.manage-account', 'personnel.view-sensitive', 'personnel.import', 'personnel.export', 'students.view', 'students.create', 'students.update', 'students.change-status', 'students.view-sensitive', 'students.import', 'students.export', 'classrooms.view', 'classrooms.create', 'classrooms.update', 'classrooms.activate', 'classrooms.assign-homeroom', 'classrooms.manage-students', 'classrooms.map-legacy', 'classrooms.copy-structure', 'classrooms.promote', 'users.view', 'users.create', 'users.update', 'users.activate', 'users.reset-password', 'users.assign-role', 'roles.view']],
