...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = collect([
            ...
            'billing-periods.view', 'billing-periods.manage',
            ...
            'payroll-periods.view', 'payroll-periods.create', 'payroll-periods.manage',
            'payrolls.calculate', 'payrolls.review', 'payrolls.approve', 'payrolls.mark-paid', 'payrolls.close', 'payrolls.reopen', 'payrolls.view', 'payrolls.view-own', 'payrolls.print', 'payrolls.export',
        ...
        Role::findByName('admin-madrasah')->syncPermissions(
            $permissions->except(['users.deactivate'])->values(),
        );
        Role::findByName('kepala-madrasah')->syncPermissions($permissions->only([
            'dashboard.view',
            'grade-levels.view',
            'classrooms.view',
            'subjects.view',
            ...
            'employee-attendances.verify',
            'employee-leaves.view',
            'employee-leaves.approve',
            'employee-leaves.reject',
            'student-attendances.view',
            'teaching-journals.view',
            'teaching-journals.verify',
            'teaching-journals.reject',
        ])->values());
        Role::findByName('tata-usaha')->syncPermissions($permissions->only([
            'dashboard.view',
            'grade-levels.view',
            'classrooms.view',
            'subjects.view',
        ...
        Role::findByName('operator')->syncPermissions($permissions->only([
            'dashboard.view',
            'grade-levels.view',
            'grade-levels.create',
            'grade-levels.update',
        ...
        Role::findByName('guru-kelas')->syncPermissions($permissions->only([
            'dashboard.view',
            'classrooms.view',
            'subjects.view',
            'teaching-assignments.view',
        ...
        Role::findByName('guru-mata-pelajaran')->syncPermissions($permissions->only([
            'dashboard.view',
            'subjects.view',
            'teaching-assignments.view',
            'schedules.view',
        ...
        Role::findByName('wali-murid')->syncPermissions([
        ...
        $financePermissions = $permissions->only([
            ...
            'billing-periods.manage',
            'student-invoices.view',
            'student-invoices.create',
            'student-invoices.generate',
            'student-invoices.update',
            'student-invoices.cancel',
            'student-invoices.export',
            'student-payments.view',
            'student-payments.create',
            'student-payments.cancel',
            'student-payments.print',
            'student-payments.export',
            'student-discounts.view',
            'student-discounts.manage',
            'student-discounts.approve',
        ...
        Role::findByName('bendahara')->syncPermissions(
            $financePermissions->merge([$permissions['dashboard.view']]),
        );
        Role::findByName('kepala-madrasah')->givePermissionTo([
            'student-invoices.view',
            'student-payments.view',
            'finance-reports.view',
            'payrolls.view',
        ...
        Role::findByName('tata-usaha')->givePermissionTo([
            'fee-types.view',
            'student-invoices.view',
            'student-payments.view',
        ]);
        ...
        foreach ([
            ...
            Role::findByName($employeeRole)->givePermissionTo('payrolls.view-own');
        }
        ...
        Role::findByName('guru-kelas')->givePermissionTo([
            'assessments.view-own',
            'assessments.create',
            'assessments.update',
            'assessments.publish',
        ...
        Role::findByName('guru-mata-pelajaran')->givePermissionTo([
            'assessments.view-own',
            'assessments.create',
            'assessments.update',
            'assessments.publish',
        ...
        Role::findByName('guru-btaq-murobi')->givePermissionTo([
            'btaq-groups.view',
            'btaq-journals.view-own',
            'btaq-journals.create',
            'btaq-journals.update',
