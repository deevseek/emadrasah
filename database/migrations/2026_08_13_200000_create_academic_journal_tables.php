...
return new class extends Migration {
    ...
    {
        // MySQL commits DDL implicitly. A failed previous attempt can therefore
        // leave one table behind while this migration is still pending.
        ...
        if (! Schema::hasTable('classroom_journals')) {
