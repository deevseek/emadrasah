...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('btaq_groups', function (Blueprint $table): void {
            ...
            $table->timestamps();
            $table->unique(['academic_year_id', 'code'], 'btaq_group_code_unique');
            $table->index(['semester_id', 'employee_id'], 'btaq_group_teacher_index');
        });
        Schema::create('btaq_group_students', function (Blueprint $table): void {
            ...
            $table->text('notes')->nullable();
            $table->timestamps();
            $table->index(['student_id', 'status'], 'btaq_member_status_index');
        });
        Schema::create('btaq_journals', function (Blueprint $table): void {
            ...
            $table->timestamps();
            $table->unique(['btaq_group_id', 'journal_date', 'session_number'], 'btaq_journal_session_unique');
        });
        Schema::create('btaq_journal_students', function (Blueprint $table): void {
            ...
            $table->timestamps();
            $table->unique(['btaq_journal_id', 'student_id'], 'btaq_journal_student_unique');
        });
