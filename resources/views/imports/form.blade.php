...
<label>Pilih File Excel<input required type="file" name="file" accept=".xlsx" class="mt-1 block w-full rounded border p-2"></label><div class="md:col-span-2"><button class="rounded bg-emerald-900 px-5 py-2 text-white">Periksa Data</button></div></form></div>
