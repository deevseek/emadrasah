...
<table>
    ...
    <tr><td>Username portal</td><td>: {{ $student->nisn }}</td></tr>
</table>
<p>Silakan masuk melalui <a href="{{ route('parent.login') }}">Portal Orang Tua</a> menggunakan NISN anak di atas. Demi keamanan, kami tidak pernah mengirimkan password melalui email.</p>
