...
<div class="page-header">
  ...
  <div class="flex w-full flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
    <div class="min-w-0"><h1 class="text-2xl font-bold tracking-tight text-emerald-950">{{ $title }}</h1>@if($description)<p class="mt-1 max-w-3xl text-sm text-slate-500">{{ $description }}</p>@endif</div>
