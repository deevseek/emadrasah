...
<div class="page-header">
  ...
  <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
    ...
    @if($primary || $secondary || trim($actions ?? ''))<div class="flex flex-col items-stretch gap-2 sm:flex-row sm:flex-wrap sm:items-center lg:justify-end">{{ $secondary }}{{ $primary }}{{ $actions ?? '' }}</div>@endif
  </div>
</div>
