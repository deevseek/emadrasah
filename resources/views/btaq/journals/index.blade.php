<x-module-page title="Jurnal BTAQ" subtitle="Halaman operasional Jurnal BTAQ.">
    <div class="rounded-xl bg-white p-6 shadow">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm">
                ...
                <tbody><tr class="border-t"><td class="px-3 py-3">Jurnal BTAQ</td><td class="px-3 py-3"><span class="rounded-full bg-emerald-100 px-2 py-1 text-emerald-900">Aktif</span></td><td class="px-3 py-3"><span class="text-gray-500">Gunakan form dan tombol pada workflow terkait.</span></td></tr></tbody>
            </table>
        </div>
    </div>
</x-module-page>
