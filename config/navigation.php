...
return [
    ...
    ['label'=>'HRD / Kepegawaian','items'=>[
        ...
        ['label'=>'Perangkat Saya','route'=>'hrd.attendance-devices.mine','active'=>'hrd.attendance-devices.mine','permission'=>'personnel-attendance.register-device','icon'=>'filter'],
        ['label'=>'Validasi Perangkat','route'=>'hrd.attendance-devices.index','active'=>'hrd.attendance-devices.index','permission'=>'personnel-attendance.manage-devices','icon'=>'filter'],
    ...
    [
        'label' => 'Aplikasi Eksternal',
        'roles' => ['operator', 'kepala-madrasah', 'super-admin'],
        'items' => [
            ['label' => 'EMIS 4.0', 'url' => 'https://emis.kemenag.go.id/login', 'external' => true, 'icon' => 'school'],
            ['label' => 'EMISGTK', 'url' => 'https://emisgtk.kemenag.go.id/login', 'external' => true, 'icon' => 'school'],
            ['label' => 'SDM DATA', 'url' => 'https://sdm.data.kemendikdasmen.go.id/', 'external' => true, 'icon' => 'school'],
            ['label' => 'PD DATA', 'url' => 'https://pd.data.kemendikdasmen.go.id/', 'external' => true, 'icon' => 'school'],
            ['label' => 'VERVALPD', 'url' => 'https://vervalpd.data.kemendikdasmen.go.id/', 'external' => true, 'icon' => 'school'],
            ['label' => 'VERVALPTK', 'url' => 'https://vervalptk.data.kemendikdasmen.go.id/', 'external' => true, 'icon' => 'school'],
            ['label' => 'VERVALSP', 'url' => 'https://vervalsp.data.kemendikdasmen.go.id/', 'external' => true, 'icon' => 'school'],
            ['label' => 'PENCARIAN NISN', 'url' => 'https://nisn.data.kemendikdasmen.go.id/', 'external' => true, 'icon' => 'school'],
            ['label' => 'PDUM', 'url' => 'https://pdum.kemenag.go.id/', 'external' => true, 'icon' => 'school'],
            ['label' => 'PORTAL DATA INDUK IJAZAH', 'url' => 'https://ijazah.pendidikan.go.id/', 'external' => true, 'icon' => 'school'],
            ['label' => 'MANAJEMEN IJAZAH', 'url' => 'https://ijazah.data.kemendikdasmen.go.id/manajemen/#/sign-in?redirectURL=%2Fberanda', 'external' => true, 'icon' => 'school'],
            ['label' => 'EDM', 'url' => 'https://edm-fe.erkam-v2.kemenag.go.id/login', 'external' => true, 'icon' => 'school'],
            ['label' => 'ERKAM', 'url' => 'https://frontend.erkam-v2.kemenag.go.id/login', 'external' => true, 'icon' => 'school'],
            ['label' => 'BIO AN', 'url' => 'https://bioportal.kemendikdasmen.go.id/', 'external' => true, 'icon' => 'school'],
            ['label' => 'AN', 'url' => 'https://anbk.kemendikdasmen.go.id/', 'external' => true, 'icon' => 'school'],
            ['label' => 'TKA', 'url' => 'https://tka.kemendikdasmen.go.id/', 'external' => true, 'icon' => 'school'],
            ['label' => 'PIP MADRASAH', 'url' => 'https://pipmadrasah.kemenag.go.id/', 'external' => true, 'icon' => 'school'],
            ['label' => 'PIP KEMENDIKDASMEN', 'url' => 'https://pip.kemendikdasmen.go.id/home_v1', 'external' => true, 'icon' => 'school'],
            ['label' => 'SEKOLAH KITA', 'url' => 'https://sekolah.data.kemendikdasmen.go.id/', 'external' => true, 'icon' => 'school'],
            ['label' => 'SPMB ADMIN', 'url' => 'https://adminspmb.demakkab.go.id/login', 'external' => true, 'icon' => 'school'],
            ['label' => 'SPMB AKUN', 'url' => 'https://spmb.demakkab.go.id/', 'external' => true, 'icon' => 'school'],
        ],
    ],
