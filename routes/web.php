...
use App\Http\Controllers\Academic\TeachingAssignmentImportController;
use App\Http\Controllers\Academic\ScheduleImportController;
use App\Http\Controllers\Academic\ImportBatchController;
...
Route::middleware(['auth', 'active'])->group(function (): void {
    ...
    Route::get('/employees/import/template', [EmployeeController::class, 'importTemplate'])->middleware('permission:employees.create')->name('employees.import.template');
