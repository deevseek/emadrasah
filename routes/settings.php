...
Route::middleware(['auth', 'active', 'force-password-change'])->prefix('pengaturan')->group(function (): void {
    ...
    Route::post('/aplikasi/face-recognition/restart', [ApplicationSettingController::class, 'restartFaceRecognition'])->middleware(['permission:hrd-settings.update', 'throttle:3,1'])->name('application-settings.face-recognition.restart');
